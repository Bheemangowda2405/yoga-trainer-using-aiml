const BASE_PATH = '/static/suryanamaskara/';

const poses = [
  { name: 'Pranamasana', sub: 'Prayer pose', img: BASE_PATH + 'pranamasana_500px.jpg' },
  { name: 'Hastauttanasana', sub: 'Raised arms pose', img: BASE_PATH + 'HASTAUTTANASANA_resized.jpg' },
  { name: 'Hastapadasana', sub: 'Standing forward bend', img: BASE_PATH + 'PADAHASTASANA2_500px.jpg' },
  { name: 'Ashwa Sanchalanasana', sub: 'Equestrian pose', img: BASE_PATH + 'public/ASHWASANCHALANASANA .jpeg' },
  { name: 'Dandasana', sub: 'Stick pose', img: BASE_PATH + 'public/PARVATASANA2.jpeg' },
  { name: 'Ashtanga Namaskara', sub: 'Salute with eight parts', img: BASE_PATH + 'public/ASHTANGANAMASKARA .jpeg' },
  { name: 'Bhujangasana', sub: 'Cobra pose', img: BASE_PATH + 'public/bhujagasana.jpg' },
  { name: 'Adho Mukha Svanasana', sub: 'Downward facing dog', img: BASE_PATH + 'public/parvatasana.jpeg' },
  { name: 'Ashwa Sanchalanasana', sub: 'Equestrian pose', img: BASE_PATH + 'public/ASHWASANCHALANASANA2 .jpeg' },
  { name: 'Hastapadasana', sub: 'Standing forward bend', img: BASE_PATH + 'PADAHASTASANA2_500px.jpg' },
  { name: 'Hastauttanasana', sub: 'Raised arms pose', img: BASE_PATH + 'HASTAUTTANASANA_resized.jpg' },
  { name: 'Pranamasana', sub: 'Prayer pose', img: BASE_PATH + 'pranamasana_500px.jpg' }
];
...
const PRACTICE_STEPS = [
  { name: 'Pranamasana', file: BASE_PATH + 'public/pranamasana.jpeg', mantra: 'ॐ मित्राय नमः', audio: BASE_PATH + 'public/voice_preview_surya namaskar voice (1).mp3' },
  { name: 'Hastauttanasana', file: BASE_PATH + 'public/HASTAUTTANASANA 2.jpeg', mantra: 'ॐ रवये नमः', audio: BASE_PATH + 'public/voice_preview_surya namaskar voice_[cut_2sec].mp3' },
  { name: 'Hastapadasana', file: BASE_PATH + 'public/PADAHASTASANA.jpeg', mantra: 'ॐ सूर्याय नमः', audio: BASE_PATH + 'public/voice_preview_surya namaskar voice_[cut_2sec] (1).mp3' },
  { name: 'Ashwa Sanchalanasana', file: BASE_PATH + 'public/ASHWASANCHALANASANA .jpeg', mantra: 'ॐ भानवे नमः', audio: BASE_PATH + 'public/voice_preview_surya namaskar voice_[cut_2sec] (2).mp3' },
  { name: 'Dandasana', file: BASE_PATH + 'public/PARVATASANA2.jpeg', mantra: 'ॐ खगाय नमः', audio: BASE_PATH + 'public/voice_preview_surya namaskar voice_[cut_2sec] (3).mp3' },
  { name: 'Ashtanga Namaskara', file: BASE_PATH + 'public/ASHTANGANAMASKARA .jpeg', mantra: 'ॐ पुष्णे नमः', audio: BASE_PATH + 'public/voice_preview_surya namaskar voice_[cut_2sec] (4).mp3' },
  { name: 'Bhujangasana', file: BASE_PATH + 'public/bhujagasana.jpg', mantra: 'ॐ हिरण्यगर्भाय नमः', audio: BASE_PATH + 'public/voice_preview_surya namaskar voice_[cut_2sec] (5).mp3' },
  { name: 'Adho Mukha Svanasana', file: BASE_PATH + 'public/parvatasana.jpeg', mantra: 'ॐ मरिचये नमः', audio: BASE_PATH + 'public/voice_preview_surya namaskar voice_[cut_2sec] (6).mp3' },
  { name: 'Ashwa Sanchalanasana', file: BASE_PATH + 'public/ASHWASANCHALANASANA2 .jpeg', mantra: 'ॐ आदित्याय नमः', audio: BASE_PATH + 'public/voice_preview_surya namaskar voice_[cut_2sec] (7).mp3' },
  { name: 'Hastapadasana', file: BASE_PATH + 'public/PADAHASTASANA.jpeg', mantra: 'ॐ सावित्रे नमः', audio: BASE_PATH + 'public/voice_preview_surya namaskar voice_[cut_2sec] (8).mp3' },
  { name: 'Hastauttanasana', file: BASE_PATH + 'public/HASTAUTTANASANA 2.jpeg', mantra: 'ॐ अर्काय नमः', audio: BASE_PATH + 'public/voice_preview_surya namaskar voice_[cut_2sec] (9).mp3' },
  { name: 'Pranamasana', file: BASE_PATH + 'public/pranamasana.jpeg', mantra: 'ॐ भास्कराय नमः', audio: BASE_PATH + 'public/voice_preview_surya namaskar voice_[cut_2sec] (10).mp3' }
];
